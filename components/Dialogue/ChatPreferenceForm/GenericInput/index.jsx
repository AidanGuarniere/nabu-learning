  ...
  return (
    <div className="mb-[25%] md:mb-0  xl:mb-6 md:h-auto">
      ...
      <textarea
        ...
        rows="2"
        maxLength={maxLength}
        className="resize-none h-full md:h-auto xl:h-2/3 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      />
